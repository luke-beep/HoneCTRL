...
:Disclaimer
reg query "HKCU\Software\HoneCTRL" /v "Disclaimer" >nul 2>&1 && goto CheckForUpdates
cls
echo.
echo.
call :HoneCTRLTitle
...
echo.
call :HoneCTRLTitle
echo                       %COL%[90mUnfortunately, HoneCTRL cannot supply unofficial distributions of software. If you
